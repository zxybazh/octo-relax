...
class Module:
    @R.function
    def main(xin: R.Tensor((3, 1), dtype="float32")) -> R.Tensor(dtype="float32", ndim=2):
        # x_0 = T.Var("x_0", "int64")
        # x_1 = T.Var("x_1", "int64")
        with R.dataflow():
            lv: R.Shape(ndim=2) = R.call_packed(
            ...
            gv = R.call_tir(broadcast_to, (xin,), out_sinfo=R.Tensor((3, 4), dtype="float32"))
            R.output(gv)
        return gv
